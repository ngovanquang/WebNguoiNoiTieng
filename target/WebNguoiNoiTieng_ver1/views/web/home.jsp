...
<body>
<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('<c:url value="/template/web/images/img_2.jpg"/>');">
    <div class="container">
            ...
            <div class="col-md-12 col-lg-8 main-content">
                ...
                <div class="post-content-body">
                    ...
                    <div class="row mb-5 mt-5">
                        <div class="col-md-12 mb-4">
                            <img src="<c:url value="/template/web/images/img_1.jpg"/>" alt="Image placeholder" class="img-fluid rounded">
                        </div>
                        <div class="col-md-6 mb-4">
                            <img src="<c:url value="/template/web/images/img_2.jpg"/>" alt="Image placeholder" class="img-fluid rounded">
                        </div>
                        <div class="col-md-6 mb-4">
                            <img src="<c:url value="/template/web/images/img_3.jpg"/>" alt="Image placeholder" class="img-fluid rounded">
                        </div>
                    </div>
                ...
                <div class="pt-5">
                    ...
                    <ul class="comment-list">
                        <li class="comment">
                            <div class="vcard">
                                <img src="<c:url value="/template/web/images/person_1.jpg"/>" alt="Image placeholder">
                            </div>
                ...
                <div class="sidebar-box">
                    ...
                    <div class="post-entry-sidebar">
                        <ul>
                            <li>
                                <a href="">
                                    <img src="<c:url value="/template/web/images/img_1.jpg"/>" alt="Image placeholder" class="mr-4">
                                    <div class="text">
                            ...
                            <li>
                                <a href="">
                                    <img src="<c:url value="/template/web/images/img_2.jpg"/>" alt="Image placeholder" class="mr-4">
                                    <div class="text">
                                        <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                        <div class="post-meta">
                                            <span class="mr-2">March 15, 2018 </span>
                            ...
                            <li>
                                <a href="">
                                    <img src="<c:url value="/template/web/images/img_3.jpg"/>" alt="Image placeholder" class="mr-4">
                                    <div class="text">
                                        <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                                        <div class="post-meta">
                                            <span class="mr-2">March 15, 2018 </span>
